...
<?php
	...
	$pageArray = array( 2 => "notre-mission.html",
						3 => "notre-savoir-faire.html",
						4 => "autour-d-une-table.html",
						5 => "asseyez-vous.html",
						6 => "a-l-air-libre.html",
						7 => "et-si-l-on-rangeait.html",
						8 => "d-autres-idees.html",
						9 => "les-news.html",
						10 => "contact.html" );
...
<head>
			...
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
			  ...
			  <meta name="google-site-verification" content="yohb5SOsPKzWGyaE9Xo2HCP7FxKDigjAwLB_JUR7sK4" />
		...
		<div id="global">
			...
			<br/>
			<span class="address">1, place Saint Sauveur<br/>34630 Saint-Thibéry France<br/>GSM: +33 6 73 45 22 50</span>
			<br/><br/>
			...
			<div id="main" style="background:url('images/Base<?php echo $id; ?>.jpg') no-repeat; min-height:265px; <?php if( $id == 9): ?>background-position:70px 0;<?php endif; ?>">
				<ul class="nav">
					<li><a href="<?php echo $pageArray[2]; ?>" <?php if( $id == 2): ?> class="active"<?php endif; ?>>Notre mission</a></li>
					<li><a href="<?php echo $pageArray[3]; ?>" <?php if( $id == 3): ?> class="active"<?php endif; ?>>Notre savoir-faire</a></li>
				</ul>
				<ul class="nav" style="margin-top:25px;">
					<li><a href="<?php echo $pageArray[4]; ?>" <?php if( $id == 4): ?>class="active"<?php endif; ?>>Autour d'une table</a></li>
					<li><a href="<?php echo $pageArray[5]; ?>" <?php if( $id == 5): ?>class="active"<?php endif; ?>>Asseyez-vous</a></li>
					<li><a href="<?php echo $pageArray[6]; ?>" <?php if( $id == 6): ?>class="active"<?php endif; ?>>A l'air libre</a></li>
					<li><a href="<?php echo $pageArray[7]; ?>" <?php if( $id == 7): ?>class="active"<?php endif; ?>>Et si l'on rangeait</a></li>
					<li><a href="<?php echo $pageArray[8]; ?>" <?php if( $id == 8): ?>class="active"<?php endif; ?>>D'autres idées</a></li>
				</ul>
				<ul class="nav" style="margin-top:25px;">
					<li><a href="<?php echo $pageArray[9]; ?>" <?php if( $id == 9): ?>class="active"<?php endif; ?>>Les news</a></li>
				</ul>
				<ul class="nav" style="margin-top:25px;">
